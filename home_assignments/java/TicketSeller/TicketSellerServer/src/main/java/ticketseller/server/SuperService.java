...
public class SuperService implements ISuperService {
    ...
    private final Map<String, ITicketObserver> loggedClients;
    ...
    @Override
    public synchronized void login(String username, String password,ITicketObserver observer) throws ServiceException {
    ...
    public synchronized void logout(String username) throws ServiceException {
        ...
        ITicketObserver ticketObserver=loggedClients.remove(username);
    ...
    private void notifyUsers(Ticket ticket){
        ...
        for(ITicketObserver observer: loggedClients.values()){
