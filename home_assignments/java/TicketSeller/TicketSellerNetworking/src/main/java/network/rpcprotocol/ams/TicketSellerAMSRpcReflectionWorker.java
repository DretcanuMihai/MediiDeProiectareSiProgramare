...
public class TicketSellerAMSRpcReflectionWorker implements Runnable{
    private IAMSSuperService server;
    private Socket connection;

    private ObjectInputStream input;
    private ObjectOutputStream output;
    private volatile boolean connected;
    public TicketSellerAMSRpcReflectionWorker(IAMSSuperService server, Socket connection) {
        this.server = server;
